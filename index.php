...
<div class="rowTutorial">

 <?php
 if ($_SESSION['tipo_acesso_usuario'] == 'Administrador') {

 ?>
  <div class="columnTutorial nature">
    <div class="content2">
  ...
  <div class="columnTutorial people">
    <div class="content2">
